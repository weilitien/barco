...
class TestNormalInput:
    ...
    def test_valid_serial_number(self, lunch_web, serial_number):
        ...
        input_area = web.find_element(By.CLASS_NAME, input_serial_number_class)
        input_area.send_keys(serial_number)
        web.find_element(By.CSS_SELECTOR, get_info_button_css).click()
        wait.until(EC.visibility_of_element_located((By.CLASS_NAME, serial_result_class)))
        result = web.find_element(By.CLASS_NAME, result_des_class)
